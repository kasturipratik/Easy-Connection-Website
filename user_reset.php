...
if(isset($_POST["getpassword"]))
{
	...
	if(empty($phone)||empty($fname)||empty($zip)||empty($username))
	{
		$error ="Input field is empty";
	}
	else{
		
		$sec_question = mysql_query("SELECT password FROM user WHERE username = '".$username."' and firstname ='".$fname."' and ph_number ='".$phone."' and zipcode ='".$zip."' ");
...
if(isset($_POST["getpassword"]))
{
	...
	if(empty($phone)||empty($fname)||empty($zip)||empty($username))
	{
		...
		$sec_question = mysql_query("SELECT sec_question FROM user WHERE username = '".$username."' and firstname ='".$fname."' and ph_number ='".$phone."' and zipcode ='".$zip."' ");
	$pw = mysql_fetch_array($sec_question);
